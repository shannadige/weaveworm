...
is never listed, searched, or written. Read the spec before writing — it
owns the format, ID rules, confidence inheritance, and the charter
lifecycle. Do not improvise sections. Conversation runs per the voice
